...
/**
 * Auto-generated: 2021-08-03 20:59:0
 *
 * @author bejson.com (i@bejson.com)
 * @website http://www.bejson.com/java2pojo/
 */
public class YandereData {
    ...
    public boolean getIs_rating_locked() {
    ...
    public void setFrames_pending(List<String> frames_pending) {
        this.frames_pending = frames_pending;
    }

    public List<String> getFrames_pending() {
    ...
    public boolean getIs_note_locked() {
